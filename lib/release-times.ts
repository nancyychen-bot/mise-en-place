...
const KNOWN_RELEASES: Record<string, ReleaseInfo> = {
  ...
  'don angie': { daysAhead: 14, time: '09:00' },
  'lilia': { daysAhead: 14, time: '09:00' },
  'i sodi': { daysAhead: 14, time: '09:00' },
  ...
  'red hook tavern': { daysAhead: 14, time: '09:00' },
  'minetta tavern': { daysAhead: 14, time: '10:00' },
  'cote': { daysAhead: 30, time: '10:00' },
  'four horseman': { daysAhead: 14, time: '09:00' },
  'thai diner': { daysAhead: 14, time: '09:00' },
