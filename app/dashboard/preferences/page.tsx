...
const DEFAULTS: Omit<UserSettings, 'userId' | 'resyApiKey' | 'ntfyTopic' | 'ntfyPriority' | 'monitoringEnabled' | 'resyAuthToken' | 'opentableSession' | 'sevenroomsAuthToken' | 'tokenExpired' | 'phoneNumber' | 'stripePaymentMethod'> = {
  earliestTime: '18:00',
  latestTime: '20:00',
  dayRange: 7,
  daysOfWeek: 'all',
